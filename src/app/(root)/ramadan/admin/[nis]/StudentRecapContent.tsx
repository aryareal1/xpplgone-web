                    ...
                    <div className="space-y-6 pt-6 pb-2">
                      ...
                      <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-800/50">
                        ...
                        <div className="grid grid-cols-1 gap-y-3">
                          ...
                          <IbadahRow
                            label="Shalat Ashar"
                            status={log?.ashar ?? false}
                          />
                          <IbadahRow
                            label="Shalat Maghrib"
                            status={log?.maghrib ?? false}
                          />
                          <IbadahRow
                            label="Shalat Isya"
                            status={log?.isya ?? false}
                          />
                        </div>
                      </div>
                      ...
                      <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-800/50">
                        ...
                        <div className="grid grid-cols-1 gap-y-3">
                          <IbadahRow
                            label="Shalat Dhuha"
                            status={log?.dhuha ?? false}
                          />
                          <IbadahRow
                            label="Shalat Tarawih"
                            status={log?.tarawih ?? false}
                          />
                          <IbadahRow
                            label="Shalat Witir"
                            status={log?.witir ?? false}
                          />
                          <IbadahRow
                            label="Shalat Tahajjud"
                            status={log?.tahajud ?? false}
                          />
                          <IbadahRow
                            label="Shalat Iftitah"
                            status={log?.iftitah ?? false}
                          />
                        </div>
                      </div>
